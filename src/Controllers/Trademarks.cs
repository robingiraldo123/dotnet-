...
namespace dotnet_api.Controllers
{
    ...
    public class TrademarkController: ControllerBase {
        ...
        public TrademarkController(AlacenaContext context){
            _context = context;
        }
        ...
        [HttpPost]
        public async Task<ActionResult<Categories>> PostTrdemark(Trademarks trademark){
            _context.TrademarkList.Add(trademark);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetProducto", new { id = trademark.idTrademarks }, trademark);
        }
